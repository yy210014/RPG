...
function CreateUnitsForPlayer2 takes nothing returns nothing
    ...
    local trigger t
    local real life
    set u=CreateUnit(p, 'uw59', - 1150.8, - 6486.8, 123.402)
    set u=CreateUnit(p, 'uw58', 10760.0, - 3737.8, 23.028)
    set u=CreateUnit(p, 'uw43', - 1155.1, - 6945.8, 43.298)
    set u=CreateUnit(p, 'uw57', - 3322.1, - 6455.8, 15.832)
    set u=CreateUnit(p, 'uw48', - 3304.1, - 6932.7, 144.002)
    set u=CreateUnit(p, 'uw33', - 3665.0, - 7549.7, 188.828)
    set u=CreateUnit(p, 'uw34', - 3127.0, - 7551.4, 346.355)
    set u=CreateUnit(p, 'uw36', - 3605.5, - 8279.8, 258.417)
    set u=CreateUnit(p, 'uw42', - 3623.1, - 8646.7, 343.938)
    set u=CreateUnit(p, 'uw40', - 3627.8, - 9403.8, 50.143)
    set u=CreateUnit(p, 'uw37', - 3617.9, - 9022.4, 88.860)
    set u=CreateUnit(p, 'uw35', - 2920.4, - 9338.2, 64.832)
    set u=CreateUnit(p, 'uw45', - 2418.3, - 9334.3, 200.100)
    set u=CreateUnit(p, 'uw32', - 1910.2, - 9326.3, 63.327)
    set u=CreateUnit(p, 'uw54', - 1402.3, - 9335.9, 254.154)
    set u=CreateUnit(p, 'uw39', - 831.4, - 9250.6, 268.932)
    set u=CreateUnit(p, 'uw56', - 1399.0, - 7505.6, 310.066)
    set u=CreateUnit(p, 'uw52', - 828.5, - 7534.8, 131.247)
    set u=CreateUnit(p, 'uw50', - 838.4, - 8015.8, 44.364)
    set u=CreateUnit(p, 'uw51', - 834.4, - 8485.3, 238.367)
    set u=CreateUnit(p, 'uw46', - 843.6, - 8883.5, 70.359)
    set u=CreateUnit(p, 'uw55', 11635.7, - 13629.9, 328.974)
    set u=CreateUnit(p, 'uw44', 11001.4, - 8401.4, 98.880)
    set u=CreateUnit(p, 'uw38', 4989.9, - 11928.2, 247.881)
    set u=CreateUnit(p, 'uw31', 5173.2, - 14659.4, 256.890)
    set u=CreateUnit(p, 'uw41', 9345.5, - 12920.1, 138.597)
    set u=CreateUnit(p, 'uw47', 8021.0, - 8107.1, 133.499)
    set u=CreateUnit(p, 'uw49', 5046.1, - 7042.7, 316.987)
    set u=CreateUnit(p, 'uw53', - 908.2, - 5440.9, 199.617)
endfunction
//===========================================================================
